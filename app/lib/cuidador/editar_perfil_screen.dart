...
// ... (restante da classe _EditPerfilScreenState sem alterações) ...
 ...
 void initState() {
  ...
  _numeroController = TextEditingController(text: widget.caregiverData.numero);
  _dataNascimentoController = TextEditingController(text: widget.caregiverData.dataNascimento);
  _enderecoController = TextEditingController(text: widget.caregiverData.endereco);
  _infoFisicasController = TextEditingController(text: widget.caregiverData.infoFisicas);
 }
 ...
 Future<void> _salvarPerfil() async {
  ...
  try {
   const String urlApi = 'http://localhost:8000/api/cuidador/atualizar-perfil';
