...
// --- CONFIGURAÇÃO DA API ---
const String comorbidadeApiUrl = 'http://localhost:8000/api/paciente/comorbidade';
...
class _ComorbidadePacienteState extends State<ComorbidadePaciente> {
  ...
  Future<void> sendComorbidadeToApi() async {
    ...
    print('Enviando comorbidade: ${comorbidadeText.isEmpty ? 'Vazia' : comorbidadeText} para a API...');
          ...
          try {
           ...
           if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
             const SnackBar(content: Text('Falha ao salvar comorbidade. Verifique a conexão com a API.')),
            );
           }
          } finally {
           if(mounted) {
