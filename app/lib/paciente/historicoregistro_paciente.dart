...
class _HistoricoDeRegistrosState extends State<HistoricoDeRegistros> {
  ...
  Map<String, dynamic> _convertToStringKeyMap(Map<dynamic, dynamic> originalMap) {
        ...
        if (response.statusCode == 200) {
          ...
          if (decoded is Map && decoded['success'] == true && decoded['data'] is List) {
            ...
            for (var paciente in data) {
              ...
              final pacienteMap = _convertToStringKeyMap(paciente as Map<dynamic, dynamic>);
              ...
              switch (i) {
                case 0: // Consultas
                  if (pacienteMap['consultas'] is List) {
                    for (var consulta in pacienteMap['consultas'] as List) {
                      ...
                      final consultaMap = _convertToStringKeyMap(consulta as Map<dynamic, dynamic>);
                ...
                case 1: // Medicamentos
                  if (pacienteMap['medicamentos'] is List) {
                    for (var medicamento in pacienteMap['medicamentos'] as List) {
                      final medicamentoMap = _convertToStringKeyMap(medicamento as Map<dynamic, dynamic>);
                      registros.add({
                        ...medicamentoMap,
                        'paciente_nome': pacienteMap['nome'],
                        'paciente_id': pacienteMap['id']
  ...
  Widget _buildRecordCard(String title, String date, String description, IconData icon, Color color) {
    return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          _buildSummaryItem(_consultas.length, 'Consultas', Icons.medical_services),
                          _buildSummaryItem(_medicamentos.length, 'Medicamentos', Icons.medication),
                          ...
                          child: ListView(
                            children: [
                              ...
                              if (_medicamentos.isNotEmpty) ...[
                                ..._medicamentos.map((medicamento) => _buildMedicamentoCard(medicamento)),
                              ] else
                                _buildEmptyState('Nenhum medicamento registrado'),
                              
                              // Tarefas
                              if (_tarefas.isNotEmpty) ...[
                                ..._tarefas.map((tarefa) => _buildTarefaCard(tarefa)),
                              ] else
    ...
    return Column(
      children: [
        Container(
          ...
          child: Icon(icon, color: const Color.fromARGB(255, 106, 186, 213), size: 24),
        ),
